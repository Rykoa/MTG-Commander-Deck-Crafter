...
- `agent/agent.py` — Claude agent with streaming + agentic tool use loop
...
- `ui/cli.py` — Rich terminal chat interface
- `data/cache/` — Auto-populated Scryfall response cache

## Build Phases
- **Phase 1 (COMPLETE):** Scryfall tools, Claude agent loop, system prompt, CLI
- **Phase 2 (NEXT):** EDHREC integration, Commander Spellbook combos, deck analyzer
- **Phase 3:** Budget engine, import/export, Streamlit web UI
